                        ...
                        <div class="cr-card-content ">
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('subcategories.edit',$value->id) }}">Edit</a>
                                                        <a class="dropdown-item" href="{{ route('subcategories.destroy',$value->id) }}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div id="pagination" class="d-flex justify-content-between">
                                ...
                                <div class="">
                                    ...
                                    <p class="sm " >Hiển thị {{ $subCate->firstItem() }} đến {{ $subCate->lastItem() }} của {{ $subCate->total() }}
                                        mục</p>
                                </div>
                                    ...
                                    <ul class="pagination">
                                        ...
                                        @for ($i = 1; $i <= $subCate->lastPage(); $i++)
                                            <li class="page-item {{ $subCate->currentPage() == $i ? 'active' : '' }}">
                                                <a class="page-link" href="{{ $subCate->url($i) }}">{{ $i }}</a>
                                            </li>
                                        @endfor
                                        <li
