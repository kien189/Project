                                ...
                                <div class="best-seller-table">
                                    <div class="table-responsive">
                                        <table id="best_seller_data_table" class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/clients/1.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/clients/2.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/clients/3.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/clients/4.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/clients/5.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/clients/6.jpg"
                                ...
                                <div class="top-product-table">
                                    <div class="table-responsive">
                                        <table id="top_product_data_table" class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/product/1.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/product/2.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/product/3.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/product/4.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/product/5.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/product/6.jpg"
                                        ...
                                        <table id="recent_order_data_table" class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/product/7.jpg"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/product/8.jpg"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/product/9.jpg"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img class="cat-thumb" src="{{asset('assets_ad')}}/img/product/10.jpg"
                                                            alt="clients Image"><span class="name">Camera Dron</span>
                                                    </td>
                                                    <td>Anne Ortha</td>
                                                    <td>$854</td>
